...
[
  {
    ...
    "help": "Specify the Snowplow Ecommerce API to use. If you already use Google Analytics 4 ecommerce or Universal Analytics Enhanced Ecommerce to collect information about the shopping behavior of your users, you can use the respective APIs as a way to quickly implement Snowplow Ecommerce without making many changes on your current setup. However to get the full value of it, you should properly plan a full migration towards Snowplow Ecommerce API.",
    ...
    "subParams": [
      {
        ...
        "subParams": [
          ...
          {
            "type": "GROUP",
            "name": "advancedTrackerSettingsGroup",
            "displayName": "Advanced Tracker Settings",
            "groupStyle": "ZIPPY_CLOSED",
            "subParams": [
              {
                "type": "TEXT",
                ...
                "help": "The global function name to be created. \u003cstrong\u003eWarning:\u003c/strong\u003e Changing the default value requires a corresponding change to the template\u0027s \u003cstrong\u003eAccesses global variables\u003c/strong\u003e permission.",
                "valueValidators": [
                  {
                    "type": "NON_EMPTY"
                  }
 ...
 */
const getSp = (tagConfig) => {
  const globalName = tagConfig.globalName;
...
const handleSnowplowEcommerce = (spName, commander, tagConfig) => {
  ...
  spName(commander(tagConfig.spEcomFunction), mergeTo(args, commonParams));
  return 'ok';
};
...
const handleGA4Ecommerce = (spName, commander, tagConfig) => {
  ...
  const method = tagConfig.ga4EcomFunction;
  switch (method) {
...
const handleUAEcommerce = (spName, commander, tagConfig) => {
  ...
  const method = tagConfig.uaEcomFunction;
  switch (method) {
